        ...
        <div className="space-y-6">
            ...
            <div className="rounded-2xl border bg-white p-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <label className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-semibold">Archiver ce chantier</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border bg-white p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
              <div>
                ...
                <input value={clientNom} onChange={(e) => setClientNom(e.target.value)} className="w-full rounded-xl border px-3 py-2" />
              </div>

              <div>
                <label className="block text-sm font-semibold mb-1">Téléphone</label>
                <input value={clientTel} onChange={(e) => setClientTel(e.target.value)} className="w-full rounded-xl border px-3 py-2" />
              </div>

              <div>
                <label className="block text-sm font-semibold mb-1">Email</label>
                <input value={clientEmail} onChange={(e) => setClientEmail(e.target.value)} className="w-full rounded-xl border px-3 py-2" />
              </div>

              <div className="lg:col-span-2">
                <label className="block text-sm font-semibold mb-1">Adresse</label>
                <textarea value={clientAdresse} onChange={(e) => setClientAdresse(e.target.value)} className="w-full rounded-xl border px-3 py-2 min-h-[80px]" />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border bg-white p-4">
            <div className="flex items-center justify-between gap-2 mb-3">
              ...
              <button type="button" className="rounded-lg border px-3 py-1.5 text-xs font-semibold hover:bg-slate-50" onClick={() => refreshStaff()} disabled={staffLoading}>
  ...
  .map((m) => {
          ...
          <div className="rounded-2xl border bg-white p-4">
            ...
            <div className="text-xs text-slate-500 mt-2">
              (Le bloc “CLIENT” est stocké automatiquement, tu n’as rien à écrire ici pour le client.)
            </div>
          </div>
          ...
          <a key={p.id} href={p.fileUrl} target="_blank" rel="noreferrer">
            ...
            {editingId ? (
              <div className="mt-4 flex items-center justify-end">
                <button type="button" className="rounded-xl border px-3 py-2 text-sm font-semibold hover:bg-slate-50" onClick={() => openPdf(editingId)} disabled={saving}>
                  Ouvrir PDF
                </button>
              </div>
            ) : null}
